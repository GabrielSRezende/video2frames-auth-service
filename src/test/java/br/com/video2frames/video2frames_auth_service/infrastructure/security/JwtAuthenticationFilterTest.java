...
class JwtAuthenticationFilterTest {
    ...
    void doFilterInternal_comTokenInvalido_naoAutentica() throws Exception {
        ...
        when(jwtTokenGenerator.extractSubject("token-invalido")).thenReturn(Optional.empty());
    ...
    void doFilterInternal_comTokenValido_autenticaComOEmailDoSubject() throws Exception {
        ...
        when(jwtTokenGenerator.extractSubject("token-valido")).thenReturn(Optional.of("gabriel@video2frames.com"));
